...
async def cmd_start(message: Message, user: User) -> None:
    ...
    intro_3 = (
        "💪 Усилить резюме\n\n"
        "<b>Вход:</b> список ссылок на вакансии hh.ru (до 8 штук)\n"
        ...
        "• Готовые формулировки для добавления в резюме, ctrl+c ctrl+v, и позиции из резюме, в которых они быть правдой\n\n"
    ...
    intro_4 = (
        "💼 Отклик на вакансию\n\n"
        "<b>Вход:</b> ссылка на 1 вакансию hh.ru\n"
        "⚠️ Требуется загруженное резюме (сначала используй CV)\n\n"
        "<b>Что получишь:</b>\n"
