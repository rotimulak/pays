...
Загрузите ваше резюме в формате <b>PDF</b>, <b>DOCX</b> или <b>TXT</b>.
...
ERROR_MESSAGES = {
    FileValidationError.INVALID_FORMAT: "❌ Неверный формат файла. Поддерживаются только PDF, DOCX и TXT.",
